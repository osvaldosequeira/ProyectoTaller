...
<div class="container my-5 text-white">
    <div class="border-bottom border-secondary pb-3 mb-5">
        <h1 class="display-5 fw-bold text-uppercase" style="font-family: 'Playfair Display', serif;">
            Panel Administrativo
        </h1>
        <p class="text-muted small">
            Métricas de control para {{ Auth::user()->name }}
        </p>
    </div>
...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-3">
        <div class="p-4" style="background: rgba(16, 185, 129, 0.15); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 15px;">
            ...
            <h2 class="fw-bold m-0">
                ${{ number_format($totalVentasComerciales, 2, ',', '.') }}
            </h2>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="p-4" style="background: rgba(168, 85, 247, 0.15); border: 1px solid rgba(168, 85, 247, 0.3); border-radius: 15px;">
            <span class="small fw-bold d-block mb-1 text-uppercase">
                Ventas Realizadas
            </span>
            <h2 class="fw-bold m-0">
                {{ $totalVentas }}
...
<div class="p-4" style="background: rgba(30, 41, 59, 0.8); border-radius: 20px; border: 1px solid rgba(255,255,255,0.1);">
    ...
    <h4 class="fw-bold mb-4" style="font-family: 'Playfair Display', serif;">
