                ...
                <tr class="FILA-MYSTERY">
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                            <a href="{{ route('admin.productos.edit', $p->id) }}" class="btn btn-sm btn-outline-warning fw-bold">Editar</a>
                            ...
                            <form action="{{ route('admin.productos.destroy', $p->id) }}" method="POST" 
                                ...
                                @csrf 
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-outline-danger fw-bold">Borrar</button>
                            </form>
                        </div>
                    </td>
                </tr>
